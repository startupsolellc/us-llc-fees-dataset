...
| Some cited URLs had gone dead since they were last opened | 0 open, of 17 found | closed: most were re-sourced against the publisher's own successor page, and the remainder turned out not to be dead at all — bot protection, a network condition, or a live page that an automated probe had misread. A dead link is never replaced by a guess, and every replacement was opened in a browser before it was written |
